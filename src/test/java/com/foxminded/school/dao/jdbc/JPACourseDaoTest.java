...
class JPACourseDaoTest {
    ...
    void shouldFindById() throws SQLException {
        ...
        assertEquals(Optional.of(course), service.findById(1000L));
    }
    ...
    void shouldFindAll() throws SQLException {
        assertEquals(List.of(new Course(1000L, "test", null),
                ...
                new Course(500L, "test2", null)), service.findAll());
    }
    ...
    void shouldDeleteById() throws SQLException {
        service.deleteById(1000L);
        assertEquals(Optional.empty(), service.findById(1000L));
    }

    @Test
    void shouldNotDeleteById() {
        Exception thrown = assertThrows(SQLException.class, () -> service.deleteById(123L));
    ...
    void shouldCreate() throws SQLException {
        ...
        assertEquals(course, service.save(new Course(null, "create", null)));
    }

    @Test
    void shouldUpdate() {
        assertDoesNotThrow(() -> service.save(new Course(1000L, "TEST1", null)));
    }

    @Test
    void shouldNotUpdate() {
        Exception thrown = assertThrows(SQLException.class, () -> service.save(new Course(123L, "fail", null)));
        assertEquals("Course doesn't exist", thrown.getMessage());
    }
    ...
    void shouldFindRelatedStudents() {
        ...
        assertEquals(students, service.findRelatedStudents(1000L));
    }

    @Test
    void shouldNotFindRelatedStudents() {
        JPAStudentDao JPAStudentDao = new JPAStudentDao();
        JPAStudentDao.deleteCourse(1000L, 1000L);
        assertEquals(new ArrayList<>(), service.findRelatedStudents(1000L));
    }
}